...
<cfoutput>
    <div id="column_left" style="margin:25px 0px;"><!--- column_left --->
...
<div id="ticket_tabs" style="float:left; max-width:1350px; width:100%; min-height:700px;">   
    ...
    <div id="main_content" style="float:left; width:100%; max-width:1300px;  min-width:200px;">
        <div style="color:##F00;">
        ...
        <div id="user_record_container" data-itnss="user_record_container" class="">
